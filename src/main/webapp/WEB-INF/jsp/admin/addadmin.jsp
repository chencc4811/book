...
<form class="layui-form" action="${pageContext.request.contextPath}/admin/addadmin" method="post" enctype="multipart/form-data">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo" id="button-reg">添加</button>
