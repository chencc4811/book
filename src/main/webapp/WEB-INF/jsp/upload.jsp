...
<form class="layui-form" action="${pageContext.request.contextPath}/upload/book">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="bookName" required  lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="categoryId" lay-verify="required">
                ...
                <c:forEach items="${categoryList}" var="category">
                    <option value="${category.bookCategoryId}">${category.bookCategoryName}</option>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">选择交易地点</label>
        <div class="layui-input-block">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="bookDesc" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
